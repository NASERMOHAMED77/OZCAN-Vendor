...
import 'package:sixvalley_vendor_app/view/screens/new_edits/category_slider_screen.dart';
import 'package:sixvalley_vendor_app/view/screens/new_edits/change_color.dart';
    ...
    List<CustomBottomSheet> activateMenu = [
      ...
      CustomBottomSheet(
          ...
          onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (_) => const AddToCategorySliderScreen()))),
      CustomBottomSheet(
          image: "assets/image/story.png",
          title: "Story",
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (_) => AddStoryScreen()));
            Provider.of<SliderRepo>(context, listen: false).fetch_story(
                "https://clothing-store-production.up.railway.app/api/v1/story");
          }),
      CustomBottomSheet(
          image: "assets/image/stars.png",
          title: "High Lights",
          onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (_) => const AddToHighLightsScreen()))),
      CustomBottomSheet(
          image: "assets/image/color.png",
          title: "Category Color",
          onTap: () {
            Provider.of<SliderRepo>(context, listen: false).fetch_Categoey(
                AppConstants.editsBaseUrl + AppConstants.getCategory);
            Navigator.push(context,
                MaterialPageRoute(builder: (_) => const ChangeColorCategory()));
          }),
      CustomBottomSheet(
